UnmarkedObjectFolder := C:/Users/Mathi/OneDrive/Dokumenter/GitHub/robtek17/RunninLights/Logical/RunningLights
MarkedObjectFolder := C:/Users/Mathi/OneDrive/Dokumenter/GitHub/robtek17/RunninLights/Logical/RunningLights
...
$(AS_CPU_PATH)/RunningLig/Main.st.o: \
	...
	FORCE 
	@'$(AS_BIN_PATH)/BR.AS.IecCompiler.exe' '$(AS_PROJECT_PATH)/Logical/RunningLights/Main.st' -o '$(AS_CPU_PATH)/RunningLig/Main.st.o'  -O '$(AS_CPU_PATH)//RunningLig/Main.st.o.opt' -secret '$(AS_PROJECT_PATH)_br.as.ieccompiler.exe'

$(AS_CPU_PATH)/RunningLig/_bur_pvdef.st.o: \
	FORCE 
	@'$(AS_BIN_PATH)/BR.AS.IecCompiler.exe' '$(AS_PATH)/AS/GnuInst/V4.1.2/i386-elf/include/bur/_bur_pvdef.st' -o '$(AS_CPU_PATH)/RunningLig/_bur_pvdef.st.o'  -O '$(AS_CPU_PATH)//RunningLig/_bur_pvdef.st.opt' -secret '$(AS_PROJECT_PATH)_br.as.ieccompiler.exe'
